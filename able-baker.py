...
from randomNumber import NORMAL, UNIFORM, RANDINT, GAMMA, NumberGenerator
...
DELAY_RATE_ABLE = NumberGenerator(GAMMA, alpha=1, beta=0.5)
...
g1 = Generator(q1, Entity, None, INTERVAL_RATE.next, 50)
g1.logs = True
